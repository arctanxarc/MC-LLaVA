...
- [x] Update the full dataset. (2025/8/22)
...
Refer to `llava/build_qa.py` to generate complete training data. (Generate positive samples and negative sample recognition data)

**Start training**

`cd train; python train_joint.py`

For more details on parameter design, see `train_joint.py`.
...
The multi-concept personalized dataset proposed in our paper and a part of trained weight can be downloaded [here](https://drive.google.com/file/d/18E3lxCJsPydqEoLKjfjiX4MRozJxHgau/view?usp=sharing).

### Introduction

The dataset is a visual-language dataset tailored for multi-concept scenario customization in Vision-Language Models (VLM). It includes: 99 images sourced from the open dataset [CC12M](https://github.com/google-research-datasets/conceptual-12m), 2,020 screenshots from 50 films and TV shows, and 16,694 Q&A pairs generated by GPT-4o.
...
Simply build the dataset following our dataset structure.
